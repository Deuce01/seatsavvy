...
if (isset($_GET['cancel'])) {
    $id = $_GET['cancel'];
    $adn = "DELETE FROM  spos_orders  WHERE  order_id = ?";
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    $ret = "SELECT * FROM spos_orders WHERE order_status ='' AND customer_id = '$customer_id'  ORDER BY `spos_orders`.`created_at` DESC  ";

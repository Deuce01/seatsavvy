...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="../admin/assets/img/icons/favicon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../admin/assets/img/icons/favicon.png">
...
$ret = "SELECT * FROM  spos_orders WHERE order_code = '$order_code'";

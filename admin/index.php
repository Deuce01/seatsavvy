...
if (isset($_POST['login'])) {
  ...
  $stmt = $mysqli->prepare("SELECT admin_email, admin_password, admin_id  FROM   spos_admin WHERE (admin_email =? AND admin_password =?)"); //sql to log in user
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              <h1 class="text-white">seatsavvy POS</h1>
            </div>
          </div>
        </div>
      </div>
